...
// import "../mocks/@dotlottie/player-component/dist/dotlottie-player";
import "../mocks/dotlottie-player-component.jsx";
        ...
        {questions.length === 0 ? (
          ...
          >
            ...
            <div>
              ...
              <select
                id="topic" // Add id to associate with the label
                value={topic}
            ...
            <div>
              ...
              <select
                id="expertise" // Add id to associate with the label
                value={expertise}
            ...
            <div>
              ...
              <select
                id="numQuestions" // Add id to associate with the label
                value={numQuestions}
            ...
            <div>
              ...
              <select
                id="style" // Add id to associate with the label
                value={style}
